...
if ( is_front_page() && is_home()  )
{
	...
	elseif ($topBannerView == 'banner_view' ||  $topBannerView == 'banner_view_search_bottom' ||  $topBannerView == 'banner_view_category_upper' ||  $topBannerView == 'banner_view_search_inside' ||  $topBannerView == 'map_view'){
		// search style
